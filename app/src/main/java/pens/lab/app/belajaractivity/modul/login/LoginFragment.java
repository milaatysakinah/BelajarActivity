...
import pens.lab.app.belajaractivity.modul.profile.ProfilActivity;
...
public class LoginFragment extends BaseFragment<LoginActivity, LoginContract.Presenter> implements LoginContract.View {
    ...
    public void redirectToProfile() {
            ...
            intent.putExtra("email", (Parcelable) etEmail);
            intent.putExtra("password", (Parcelable) etPassword);
